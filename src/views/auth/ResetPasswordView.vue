  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div v-if="isInvalidLink" class="space-y-6">
        <div class="rounded-xl border border-amber-200 bg-warning-soft p-6 dark:border-amber-800/50">
          <div class="flex flex-col items-center gap-4 text-center">
            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-amber-100 dark:bg-amber-800/50">
              <Icon name="exclamationCircle" size="lg" class="text-warning" />
            </div>
            <div>
      ...
      <div v-else-if="isSuccess" class="space-y-6">
        <div class="rounded-xl border border-green-200 bg-success-soft p-6 dark:border-green-800/50">
          <div class="flex flex-col items-center gap-4 text-center">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              readonly
              disabled
              class="input pl-11 bg-surface-2"
            />
          </div>
        </div>
