      ...
      <transition name="fade">
        ...
        >
          <div
            ...
            class="rounded-xl border border-divider bg-surface-2 p-4"
          >
            <div class="space-y-3">
              <div class="space-y-1">
              ...
              <label
                ...
                class="flex items-start gap-3 rounded-lg border border-divider bg-surface p-3 text-sm"
              >
                <input v-model="adoptDisplayName" type="checkbox" class="mt-1 h-4 w-4" />
                <span class="space-y-1">
                  <span class="block font-medium text-content">
                    {{ t('auth.oauthFlow.useDisplayName') }}
                  </span>
                  <span class="block text-content-2">
              ...
              >
                ...
                <img
                  ...
                  class="h-10 w-10 rounded-full border border-divider object-cover"
                />
                <span class="space-y-1">
                  <span class="block font-medium text-content">
                    {{ t('auth.oauthFlow.useAvatar') }}
                  </span>
                  <span class="block break-all text-content-2">
                    {{ suggestedAvatarUrl }}
                  </span>
                </span>
              </label>
          ...
          <template v-else-if="needsChooser">
            <div class="rounded-xl border border-divider bg-surface-2 p-4">
              <div class="space-y-4">
                <div class="space-y-1">
                  <p class="text-sm font-medium text-content">
