<template>
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-content-2">
          {{ t('auth.sendCodeDesc') }}
          <span class="font-medium text-content-2">{{ email }}</span>
        </p>
      </div>
      ...
      <form v-else @submit.prevent="handleVerify" class="space-y-5">
        ...
        <div
          v-if="codeSent"
          class="rounded-xl border border-green-200 bg-success-soft p-4 dark:border-green-800/50"
        >
          <div class="flex items-start gap-3">
            <div class="flex-shrink-0">
        ...
        <div class="text-center">
          <button
            ...
            type="button"
            disabled
            class="cursor-not-allowed text-sm text-content-3"
          >
    ...
    <template #footer>
      <button
        @click="handleBack"
        class="flex items-center gap-2 text-content-2 transition-colors hover:text-content-2 dark:hover:text-gray-300"
      >
