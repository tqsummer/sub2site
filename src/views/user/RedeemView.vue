  ...
  <AppLayout>
    <div class="mx-auto max-w-2xl space-y-6">
            ...
            <div>
              ...
              <div class="relative mt-1">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
                  <Icon name="gift" size="md" class="text-content-3" />
                </div>
                <input
                  id="code"
                  v-model="redeemCode"
      ...
      <transition name="fade">
        <div
          v-if="redeemResult"
          class="card border-emerald-200 bg-success-soft dark:border-emerald-800/50"
        >
          <div class="p-6">
      ...
      <transition name="fade">
        <div
          v-if="errorMessage"
          class="card border-red-200 bg-danger-soft dark:border-red-800/50"
        >
          <div class="p-6">
            <div class="flex items-start gap-4">
              <div
              ...
              <div class="flex-1">
                <h3 class="text-sm font-semibold text-danger">
      ...
      <div class="card">
        ...
        <div class="p-6">
            ...
            >
              ...
              <div class="text-right">
                ...
                <p
                  ...
                  class="font-mono text-xs text-content-3"
                >
                  {{ item.code.slice(0, 8) }}...
                </p>
                ...
                <p
                  v-if="item.notes"
                  class="mt-1 text-xs text-content-2 italic max-w-[200px] truncate"
                  :title="item.notes"
                >
                  {{ item.notes }}
                </p>
          ...
          <div v-else class="empty-state py-8">
            <div
              class="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-surface-3"
            >
              <Icon name="clock" size="xl" class="text-content-3" />
            </div>
