  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <div v-else-if="subscriptions.length === 0" class="card p-12 text-center">
        <div
          class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-surface-3"
        >
          <Icon name="creditCard" size="xl" class="text-content-3" />
        </div>
      ...
      <div v-else class="grid gap-6 lg:grid-cols-2">
        <div
          ...
          :key="subscription.id"
          class="overflow-hidden rounded-2xl border bg-surface"
          :class="platformBorderClass(subscription.group?.platform || '')"
        >
          <!-- Header -->
          <div
            class="flex items-center justify-between border-b border-divider p-4"
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p v-if="subscription.group?.description" class="mt-0.5 text-xs text-content-2">
                  {{ subscription.group.description }}
                </p>
                <div class="mt-1 flex flex-wrap gap-x-3 gap-y-1 text-[11px] text-content-3">
                  <span>{{ t('payment.planCard.rate') }}: ×{{ subscription.group?.rate_multiplier ?? 1 }}</span>
                  <span v-if="subscriptionHasPeakRate(subscription)" class="text-warning">
          ...
          <div class="space-y-4 p-4">
            ...
            <div v-if="subscription.group?.daily_limit_usd" class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-sm font-medium text-content-2">
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-xs text-emerald-600/70/70">
