  ...
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        ...
        <h1 class="text-3xl font-bold text-content">{{ t('setup.title') }}</h1>
        <p class="mt-2 text-content-2">{{ t('setup.description') }}</p>
      </div>
        ...
        <div class="flex items-center justify-center">
          <template v-for="(step, index) in steps" :key="step.id">
                ...
                :class="[
                  ...
                  currentStep > index
                    ...
                    : currentStep === index
                      ...
                      : 'bg-gray-200 text-content-2 dark:bg-dark-700'
                ]"
              >
                <Icon
            ...
            <div
              ...
              :class="currentStep > index ? 'bg-primary-500' : 'bg-surface-3'"
            ></div>
          </template>
        </div>
      </div>
      ...
      <div class="rounded-2xl bg-surface p-8 shadow-xl">
        ...
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          <div class="flex items-center justify-between rounded-xl border border-divider p-3">
            <div>
              <p class="text-sm font-medium text-content">
                {{ t("setup.redis.enableTls") }}
              </p>
              <p class="text-xs text-content-2">
        ...
        <div v-if="currentStep === 3" class="space-y-6">
          ...
          <div class="space-y-4">
            <div class="rounded-xl bg-surface-2 p-4">
              <h3 class="mb-2 text-sm font-medium text-content-2">
            ...
            <div class="rounded-xl bg-surface-2 p-4">
              ...
              <p class="text-content">{{ formData.admin.email }}</p>
            </div>
          </div>
        </div>
        ...
        <div
          v-if="errorMessage"
          class="mt-6 rounded-xl border border-red-200 bg-danger-soft p-4 dark:border-red-800/50"
        >
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-xl border border-green-200 bg-success-soft p-4 dark:border-green-800/50"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
