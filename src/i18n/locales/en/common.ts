export default {
  ...
  auth: {
    ...
    errors: {
      ...
      EMAIL_RESERVED: 'This email cannot be used to register.',
      EMAIL_VERIFY_REQUIRED: 'Please verify your email first.',
      EMAIL_VERIFY_NOT_ENABLED: 'Email verification is not enabled.',
      EMAIL_NOT_CONFIGURED: 'Email service is not configured. Please contact the administrator.',
      EMAIL_SUFFIX_NOT_ALLOWED: 'This email suffix is not allowed for registration.',
      EMAIL_DOMAIN_REGISTRATION_LIMIT: 'This email domain has reached its registration limit.',
      AUTH_REQUIRED: 'Please sign in first.',
      AUTH_IDENTITY_EMAIL_MISMATCH: 'The linked account uses a different email address.',
      AUTH_IDENTITY_OWNERSHIP_CONFLICT: 'This account is already linked to another user.',
      AUTH_IDENTITY_CHANNEL_OWNERSHIP_CONFLICT: 'This account is already linked to another user.',
      AUTH_IDENTITY_CHANNEL_PROVIDER_MISMATCH: 'Sign-in provider mismatch. Please start the authorization again.',
      AUTH_IDENTITY_BIND_FAILED: 'Failed to link the account. Please try again.',
      CAPTCHA_INVALID_CREDENTIALS: 'Captcha verification failed. Please try again.',
    },
