export default {
  ...
  payment: {
    ...
    notAvailableDesc: 'No payment method is available right now.',
    notAvailableContact: 'To top up, please contact support: {contact}',
    balanceCurrencyNote: 'Current balance · USD',
    payCurrencyNote: 'Charged in {currency}',
