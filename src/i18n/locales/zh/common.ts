export default {
  ...
  auth: {
    ...
    errors: {
      ...
      EMAIL_RESERVED: '该邮箱不可用于注册。',
      EMAIL_VERIFY_REQUIRED: '请先完成邮箱验证。',
      EMAIL_VERIFY_NOT_ENABLED: '当前未开启邮箱验证。',
      EMAIL_NOT_CONFIGURED: '系统尚未配置邮件服务，请联系管理员。',
      EMAIL_SUFFIX_NOT_ALLOWED: '该邮箱后缀不在允许注册的范围内。',
      EMAIL_DOMAIN_REGISTRATION_LIMIT: '该邮箱域名的注册数量已达上限。',
      AUTH_REQUIRED: '请先登录。',
      AUTH_IDENTITY_EMAIL_MISMATCH: '第三方账号绑定的邮箱与当前账号不一致。',
      AUTH_IDENTITY_OWNERSHIP_CONFLICT: '该第三方账号已绑定到其他用户。',
      AUTH_IDENTITY_CHANNEL_OWNERSHIP_CONFLICT: '该第三方账号已绑定到其他用户。',
      AUTH_IDENTITY_CHANNEL_PROVIDER_MISMATCH: '第三方登录渠道不匹配，请重新发起授权。',
      AUTH_IDENTITY_BIND_FAILED: '第三方账号绑定失败，请重试。',
      CAPTCHA_INVALID_CREDENTIALS: '人机验证未通过，请重试。',
    },
