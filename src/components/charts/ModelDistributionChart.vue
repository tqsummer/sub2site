<template>
  <div class="card p-4">
        ...
        >
          <button
            ...
            :class="source === 'requested'
              ? 'bg-white text-content shadow-sm dark:bg-dark-700 dark:text-white'
              : 'text-content-2 hover:text-content-2 dark:hover:text-gray-200'"
            ...
            <template v-for="model in displayModelStats" :key="model.model">
              ...
              >
                <td
                  ...
                  :class="enableBreakdown ? 'text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300' : 'text-content'"
                  :title="model.model"
                >
                ...
                <td class="py-1.5 text-right text-content-2">
                ...
                <td class="py-1.5 text-right text-content-3">
    ...
    <div
      ...
      class="flex h-48 items-center justify-center text-sm text-content-2"
    >
            ...
            >
              <td class="py-1.5">
                <div class="flex min-w-0 items-center gap-2">
                  <span class="shrink-0 text-[11px] font-semibold text-content-2">
                    {{ item.isOther ? 'Σ' : `#${index + 1}` }}
                  </span>
                  <span
                    class="block max-w-[140px] truncate font-medium text-content"
