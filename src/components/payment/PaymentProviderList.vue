    ...
    <div class="p-4">
      ...
      >
        <div v-for="p in localProviders" :key="p.id" class="flex items-start gap-2">
          <div class="drag-handle mt-3 flex cursor-grab items-center text-gray-300 hover:text-content-2 active:cursor-grabbing dark:text-dark-600 dark:hover:text-content-2">
