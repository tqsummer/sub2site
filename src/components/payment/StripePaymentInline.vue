          ...
          <div class="w-full rounded-xl bg-surface-2 p-4">
            <div class="space-y-2 text-sm">
              <div class="flex justify-between">
                ...
                <span class="font-medium text-content">#{{ orderId }}</span>
              </div>
              <div v-if="amount > 0" class="flex justify-between">
                <span class="text-content-2">{{ t('payment.orders.amount') }}</span>
                <span class="font-medium text-content">{{ creditedAmountSymbol }}{{ amount.toFixed(2) }}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-content-2">{{ t('payment.orders.payAmount') }}</span>
                <span class="font-medium text-content">{{ paymentAmountSymbol }}{{ payAmount.toFixed(2) }}</span>
              </div>
            </div>
          </div>
