        ...
        :class="[
          ...
          !method.available
            ...
            : selected === method.type
              ...
              : 'border-gray-300 bg-white text-content-2 hover:border-gray-400 dark:border-dark-600 dark:bg-dark-800 dark:text-gray-200 dark:hover:border-dark-500',
        ]"
        ...
        <span class="flex w-full min-w-0 items-center justify-center gap-2">
          ...
          <span class="flex min-w-0 flex-col items-start leading-none">
            ...
            <span
              ...
              class="text-[10px] tracking-wide text-content-2"
            >
...
function methodSelectedClass(type: string): string {
  if (isBuiltInAlipayMethod(type)) return 'border-[#02A9F1] bg-blue-50 text-content shadow-sm dark:bg-blue-950 dark:text-gray-100'
  if (isBuiltInWxpayMethod(type)) return 'border-[#09BB07] bg-success-soft text-content shadow-sm dark:text-gray-100'
  if (type === 'stripe') return 'border-[#676BE5] bg-indigo-50 text-content shadow-sm dark:bg-indigo-950 dark:text-gray-100'
  if (type === 'airwallex') return 'border-[#FF6B3D] bg-orange-50 text-content shadow-sm dark:border-[#FF8E3C] dark:bg-orange-950 dark:text-gray-100'
  return 'border-primary-500 bg-primary-50 text-content shadow-sm dark:bg-primary-950 dark:text-gray-100'
}
</script>
