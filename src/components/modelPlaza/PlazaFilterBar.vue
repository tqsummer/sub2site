<template>
  <div class="space-y-3">
    ...
    <div class="flex items-start gap-2">
      <span class="w-10 shrink-0 pt-2 text-xs font-semibold uppercase tracking-wider text-content-3">
    ...
    <div class="flex flex-wrap items-start gap-2">
      ...
      <div class="relative w-full sm:w-72">
        <Icon
          name="search"
          size="sm"
          class="absolute left-3 top-1/2 -translate-y-1/2 text-content-3"
        />
        <input
          :value="search"
          type="text"
        ...
        <button
          v-if="search"
          type="button"
          class="absolute right-2.5 top-1/2 -translate-y-1/2 text-content-3 transition-colors hover:text-content-2 dark:hover:text-gray-300"
...
function chipClass(active: boolean): string {
  return active
    ...
    : 'bg-surface text-content-2 ring-1 ring-inset ring-gray-200 enabled:hover:bg-gray-50 enabled:hover:text-content enabled:hover:ring-gray-300 dark:text-dark-300 dark:ring-dark-700 dark:enabled:hover:bg-dark-800 dark:enabled:hover:text-white'
}
</script>
