<template>
  <div v-if="hasActiveSubscriptions" class="relative" ref="containerRef">
    ...
    <transition name="dropdown">
      <div
        v-if="tooltipOpen"
        class="absolute right-0 z-50 mt-2 w-[340px] overflow-hidden rounded-xl border border-divider bg-surface shadow-xl"
      >
            ...
            <div class="space-y-1.5">
              ...
              <template v-else>
                <div v-if="subscription.group?.daily_limit_usd" class="flex items-center gap-2">
                  <span class="w-8 flex-shrink-0 text-[10px] text-content-2">{{
                    t('subscriptionProgress.daily')
                  }}</span>
                  <div class="h-1.5 min-w-0 flex-1 rounded-full bg-surface-3">
                    <div
                  ...
                  <span class="w-24 flex-shrink-0 text-right text-[10px] text-content-2">
                    {{
