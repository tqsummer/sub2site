      ...
      <div v-if="isOpen" class="select-dropdown">
        ...
        <div class="select-header">
          <div class="select-search">
            <Icon name="search" size="sm" class="text-content-3" />
            <input
              ref="searchInputRef"
              v-model="searchQuery"
              type="text"
            ...
            <div class="min-w-0 flex-1">
              <div class="flex items-center gap-2">
                ...
                <span
                  ...
                  class="inline-flex flex-shrink-0 items-center rounded bg-surface-3 px-1.5 py-0.5 text-xs text-content-2"
                >
                  {{ proxy.account_count }}
                </span>
                <!-- Test result badges -->
                <template v-if="testResults[proxy.id]">
                  <span
                    ...
                    class="inline-flex flex-shrink-0 items-center gap-1 rounded bg-emerald-100 px-1.5 py-0.5 text-xs text-success"
                  >
                  ...
                  <span
                    v-else
                    class="inline-flex flex-shrink-0 items-center rounded bg-red-100 px-1.5 py-0.5 text-xs text-danger"
                  >
                    {{ t('admin.proxies.testFailed') }}
                  </span>
                </template>
              </div>
              <div class="truncate text-xs text-content-2">
...
.select-icon {
  @apply flex-shrink-0 text-content-3;
}
...
.select-search-input {
  ...
  @apply text-content;
  @apply placeholder:text-content-3 dark:placeholder:text-content-2;
  @apply focus:outline-none;
}

.batch-test-btn {
  @apply flex-shrink-0 rounded-lg p-1.5;
  @apply text-content-2 hover:text-emerald-600 dark:hover:text-emerald-400;
...
.test-btn {
  ...
  @apply text-content-3 hover:text-emerald-600 dark:hover:text-emerald-400;
  @apply hover:bg-emerald-50 dark:hover:bg-emerald-900/20;
  @apply transition-colors disabled:cursor-not-allowed disabled:opacity-50;
}
