            ...
            >
              <slot name="option" :option="option" :selected="isSelected(option)">
                <Icon
                  ...
                  name="search"
                  size="sm"
                  class="flex-shrink-0 text-content-3"
                />
                <span class="select-option-label" :class="option._creatable && 'italic text-content-2 dark:text-dark-300'">{{ getOptionLabel(option) }}</span>
                <Icon
...
.select-clear {
  ...
  @apply rounded text-content-3 transition-colors;
  @apply hover:text-content-2 dark:hover:text-gray-200;
}
</style>
