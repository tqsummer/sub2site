<template>
  <Teleport to="body">
    <Transition name="popup-fade">
      ...
      >
        <div
          class="w-full max-w-[680px] overflow-hidden rounded-3xl bg-surface shadow-2xl ring-1 ring-black/5 dark:ring-white/10"
          @click.stop
        >
          ...
          <div class="relative overflow-hidden border-b border-amber-100/80 bg-gradient-to-br from-amber-50/80 via-orange-50/50 to-yellow-50/30 px-8 py-6 dark:border-dark-700/50 dark:from-amber-900/20 dark:via-orange-900/10 dark:to-yellow-900/5">
            ...
            <div class="relative z-10">
              ...
              <!-- Title -->
              <h2 class="mb-2 text-2xl font-bold leading-tight text-content">
                {{ displayedAnnouncement.title }}
              </h2>

              <!-- Time -->
              <div class="flex items-center gap-1.5 text-sm text-content-2">
          ...
          <!-- Body -->
          <div class="max-h-[50vh] overflow-y-auto bg-surface px-8 py-8">
            <div class="relative">
