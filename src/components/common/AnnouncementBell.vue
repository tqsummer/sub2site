<template>
  <div>
    ...
    <button
      @click="openModal"
      class="relative flex h-9 w-9 items-center justify-center rounded-lg text-content-2 transition-all hover:bg-gray-100 hover:scale-105 dark:hover:bg-dark-800"
      :class="{ 'text-brand-text': unreadCount > 0 }"
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          <div
            class="w-full max-w-[620px] overflow-hidden rounded-3xl bg-surface shadow-2xl ring-1 ring-black/5 dark:ring-white/10"
            @click.stop
          >
            <!-- Header with Gradient -->
            <div class="relative overflow-hidden border-b border-divider bg-gradient-to-br from-blue-50/50 to-indigo-50/30 px-6 py-5 dark:from-blue-900/10 dark:to-indigo-900/5">
              <div class="relative z-10 flex items-start justify-between">
                <div>
                  ...
                  <p v-if="unreadCount > 0" class="mt-2 text-sm text-content-2">
                    <span class="font-medium text-brand-text">{{ unreadCount }}</span>
                ...
                <div class="flex items-center gap-2">
                  ...
                  <button
                    @click="closeModal"
                    class="flex h-9 w-9 items-center justify-center rounded-lg bg-white/50 text-content-2 backdrop-blur-sm transition-all hover:bg-white hover:text-content-2 dark:bg-dark-700/50 dark:hover:bg-dark-700 dark:hover:text-gray-300"
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-if="loading" class="flex items-center justify-center py-16">
                <div class="relative">
                  <div class="h-12 w-12 animate-spin rounded-full border-4 border-divider border-t-blue-600 dark:border-t-blue-400"></div>
              ...
              <div v-else-if="announcements.length > 0">
                <div
                  ...
                  :key="item.id"
                  class="group relative flex items-center gap-4 border-b border-divider px-6 py-4 transition-all hover:bg-gray-50 dark:hover:bg-dark-700/30"
                ...
                >
                  ...
                  <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center">
                    ...
                    <div
                      v-else
                      class="flex h-10 w-10 items-center justify-center rounded-xl bg-surface-3 text-content-3"
                    >
                  ...
                  <div class="flex min-w-0 flex-1 items-center justify-between gap-4">
                    <div class="min-w-0 flex-1">
                      <h3 class="truncate text-sm font-medium text-content">
                        {{ item.title }}
                      </h3>
                      <div class="mt-1 flex items-center gap-2">
                        <time class="text-xs text-content-2">
                    ...
                    <div class="flex-shrink-0">
                      <svg
                        class="h-5 w-5 text-content-3 transition-transform group-hover:translate-x-1"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        stroke-width="2"
              ...
              <div v-else class="flex flex-col items-center justify-center py-16">
                <div class="relative mb-4">
                  <div class="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-dark-700 dark:to-dark-600">
                    <Icon name="inbox" size="xl" class="text-content-3" />
                  </div>
                ...
                <p class="text-sm font-medium text-content">{{ t('announcements.empty') }}</p>
                <p class="mt-1 text-xs text-content-2">{{ t('announcements.emptyDescription') }}</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          <div
            class="w-full max-w-[780px] overflow-hidden rounded-3xl bg-surface shadow-2xl ring-1 ring-black/5 dark:ring-white/10"
            @click.stop
          >
            <!-- Header with Decorative Elements -->
            <div class="relative overflow-hidden border-b border-divider bg-gradient-to-br from-blue-50/80 via-indigo-50/50 to-purple-50/30 px-8 py-6 dark:from-blue-900/20 dark:via-indigo-900/10 dark:to-purple-900/5">
              ...
              <div class="relative z-10 flex items-start justify-between gap-4">
                <div class="flex-1 min-w-0">
                  ...
                  <!-- Title -->
                  <h2 class="mb-3 text-2xl font-bold leading-tight text-content">
                    {{ selectedAnnouncement.title }}
                  </h2>

                  <!-- Meta Info -->
                  <div class="flex items-center gap-4 text-sm text-content-2">
                ...
                <button
                  @click="closeDetail"
                  class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-white/50 text-content-2 backdrop-blur-sm transition-all hover:bg-white hover:text-content-2 hover:shadow-lg dark:bg-dark-700/50 dark:hover:bg-dark-700 dark:hover:text-gray-300"
                  :aria-label="t('common.close')"
                >
                  <Icon name="x" size="md" />
                </button>
            ...
            <div class="max-h-[60vh] overflow-y-auto bg-surface px-8 py-8">
            ...
            <!-- Footer with Actions -->
            <div class="border-t border-divider bg-surface-2 px-8 py-5">
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                  <button
                    @click="closeDetail"
                    class="rounded-xl border border-divider-strong bg-surface px-5 py-2.5 text-sm font-medium text-content-2 shadow-sm transition-all hover:bg-gray-50 hover:shadow dark:text-gray-300 dark:hover:bg-dark-600"
                  >
                    {{ t('common.close') }}
                  </button>
                  <button
