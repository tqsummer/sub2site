  ...
  <div class="relative inline-block">
    <span
      ...
      :class="[
        ...
        effectivePlatform
          ...
          : 'border-gray-200 bg-gray-50 text-content-2 dark:border-dark-600 dark:bg-dark-800 dark:text-gray-300',
      ]"
      @mouseenter="onEnter"
      @mouseleave="onLeave"
      @focusin="onEnter"
    ...
    >
      ...
      <span
        ...
        class="rounded bg-surface-3 px-1 text-[10px] uppercase text-content-2"
      >
        {{ model.platform }}
      </span>
      {{ model.name }}
    ...
    <Teleport to="body">
      <div
        ...
        ref="popoverEl"
        role="tooltip"
        class="pointer-events-none fixed z-[99999] w-80 max-w-[min(22rem,calc(100vw-1rem))] rounded-lg border bg-surface text-xs shadow-xl"
      ...
      >
        ...
        <div class="p-3">
          <div v-if="!model.pricing" class="text-content-2">
            {{ noPricingLabel }}
          </div>

          <div v-else class="space-y-2 text-content-2">
            <div class="flex justify-between">
              <span class="text-content-2">{{ t(prefixKey('billingMode')) }}</span>
            ...
            <div
              ...
              :class="[popoverBorderClass]"
            >
              <div class="mb-1 font-medium text-content-2">
...
const popoverHeaderClass = computed(() =>
  effectivePlatform.value
    ...
    : 'bg-surface-2 text-content-2 dark:text-gray-300',
)
