        ...
        <div v-if="step === 1" class="space-y-6">
          ...
          <template v-if="setupData">
            <div class="flex justify-center">
              <div class="rounded-lg border border-divider p-4 bg-surface dark:bg-white">
                <img :src="qrCodeDataUrl" alt="QR Code" class="h-48 w-48" />
              </div>
            </div>

            <div class="text-center">
              <p class="text-sm text-content-2 mb-2">
                {{ t('profile.totp.manualEntry') }}
              </p>
              <div class="flex items-center justify-center gap-2">
                <code class="rounded bg-surface-3 px-3 py-2 font-mono text-sm">
                  {{ setupData.secret }}
                </code>
                <button
                  type="button"
                  class="rounded p-1.5 text-content-2 hover:bg-gray-100 dark:hover:bg-dark-700"
                  @click="copySecret"
                >
            ...
            <div class="mb-6">
              ...
              <div class="flex justify-center gap-2">
                <input
                  ...
                  inputmode="numeric"
                  pattern="[0-9]"
                  class="h-12 w-10 rounded-lg border border-divider-strong text-center text-lg font-semibold focus:border-primary-500 focus:ring-primary-500 dark:bg-dark-700"
