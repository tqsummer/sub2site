        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div class="flex min-w-0 flex-1 items-start gap-4">
            <div
              ...
              class="flex h-11 w-11 shrink-0 items-center justify-center rounded-token-lg text-sm font-semibold"
            >
              <Icon
            ...
            <div class="min-w-0 flex-1 space-y-3">
              ...
              <div
                ...
                class="grid gap-1 text-sm text-content-2"
              >
                <p
                  v-if="item.provider !== 'email' && item.details?.display_name"
                  class="font-medium text-content-2"
                >
...
const rowClass = computed(() =>
  props.embedded
    ? compact.value
      ? 'rounded-token-lg border border-divider bg-surface p-4 shadow-sm'
      : 'rounded-token-lg border border-divider bg-surface-2 p-4'
    : 'px-6 py-5'
)
