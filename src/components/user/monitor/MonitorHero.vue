<template>
  <section class="py-3 md:py-4">
    <div class="flex items-center justify-end gap-3 flex-wrap">
      <div
        role="tablist"
        class="inline-flex p-0.5 rounded-xl bg-surface-3 border border-divider text-xs"
      >
        <button
          ...
          :class="window === opt.value
            ? 'bg-white dark:bg-dark-700 shadow-sm text-content font-semibold'
      ...
      <button
        type="button"
        class="h-8 w-8 rounded-lg flex items-center justify-center text-content-2 hover:text-content-2 hover:bg-gray-100 dark:hover:text-gray-200 dark:hover:bg-dark-700 transition-colors disabled:opacity-50"
        :disabled="loading"
