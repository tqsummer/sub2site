<template>
  <div class="mt-4 pt-3 border-t border-divider">
    <div
      class="flex justify-between text-[10px] font-semibold uppercase tracking-widest text-content-3 mb-2"
    >
    ...
    <div
      v-if="maintenance"
      class="flex h-5 w-full items-center justify-center rounded border border-dashed border-divider-strong text-[10px] uppercase tracking-widest text-content-3"
    >
    ...
    <div
      class="mt-1 flex justify-between text-[9px] uppercase tracking-widest text-content-3"
    >
