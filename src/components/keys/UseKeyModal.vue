<template>
  ...
  >
    <div class="space-y-4">
      ...
      <div v-if="!platform" class="flex items-start gap-3 p-4 rounded-lg bg-warning-soft border border-yellow-200 dark:border-yellow-800">
        <svg class="w-5 h-5 text-warning flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
      ...
      <template v-else>
        ...
        <!-- Client Tabs -->
        <div v-if="clientTabs.length" class="overflow-x-auto border-b border-divider">
            ...
            <button
              ...
              :class="[
                ...
                activeClientTab === tab.id
                  ...
                  : 'border-transparent text-content-2 hover:text-content-2 hover:border-gray-300 dark:hover:text-gray-300'
              ]"
            >
        ...
        >
          ...
          <div
            class="grid grid-cols-2 gap-1 rounded-lg bg-surface-3 p-1"
            role="radiogroup"
            ...
            <button
              ...
              :class="[
                ...
                codexAuthMode === 'legacy'
                  ...
                  : 'text-content-2 hover:text-content dark:text-dark-300 dark:hover:text-white'
              ]"
          ...
          <div
            ...
            class="mt-3 flex items-start gap-2 border-l-2 border-amber-400 bg-warning-soft px-3 py-2 text-xs leading-5 text-amber-800 dark:border-amber-500"
          >
        ...
        <!-- OS/Shell Tabs -->
        <div v-if="showShellTabs" class="overflow-x-auto border-b border-divider">
          ...
          >
            ...
            <div class="bg-gray-900 dark:bg-dark-900 rounded-xl overflow-hidden">
              ...
              <div class="flex items-center justify-between px-4 py-2 bg-gray-800 dark:bg-dark-800 border-b border-gray-700 dark:border-dark-700">
                <span class="min-w-0 truncate text-xs text-content-3 font-mono">{{ file.path }}</span>
                <button
                  type="button"
        ...
        <section
          ...
          class="overflow-hidden rounded-lg border border-divider bg-surface-2"
        >
          <div class="flex flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
            <div class="min-w-0">
              ...
              <p class="mt-1 truncate font-mono text-xs text-content-2">
          ...
          <p
            v-if="codexModelManifestState === 'ready'"
            class="border-t border-divider px-4 py-2 text-xs text-success"
          >
          ...
          <p
            ...
            class="border-t border-red-200 px-4 py-2 text-xs text-danger dark:border-red-900"
          >
